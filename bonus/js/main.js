...
selectFamilyDom.addEventListener('change', function() {
    ...
    } else if (selectedValue == this.value) {
...
function generateDomElement(element){
	const changeColor = generateRandomHexadecimalColorCode();
    return iconsContainerDom.innerHTML += `<div class="box"><i style='color:${changeColor};' class='fa-solid ${element.prefix}${element.name}'></i></div>`;
}
